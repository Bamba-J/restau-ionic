...
@Component({
  selector: 'app-manger2',
  templateUrl: './manger2.page.html',
  styleUrls: ['./manger2.page.scss'],
})
export class Manger2Page implements OnInit {
